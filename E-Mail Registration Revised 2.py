...
def Pagethree():
    pageThree.tkraise()
    Yourmail.configure(text = Emailent.get())
...
Passwordent.place(relx = 0.15, rely = 0.3125)

Nameent = tkinter.Entry(pageOne, width = 60)
Nameent.place(relx = 0.15, rely = 0.4625)
...
Namescreen = tkinter.Label(pageThree, text = " ", bg = "light green", font = "Papyrus, 40")
Namescreen.place(relx = 0.25, rely = 0)

UMessage = tkinter.Label(pageThree, text = "Your Username is:", bg = "light green", font = "Papyrus, 40")
UMessage.place(relx = 0.25, rely = 0.1)

Youruser = tkinter.Label(pageThree, text = " ", bg = "light green", font = "Papyrus, 40")
Youruser.place(relx = 0.25, rely = 0.15)

EMessage = tkinter.Label(pageThree, text = "Your brand new E-mail is:", bg = "light green", font = "Papyrus, 40")
EMessage.place(relx = 0.25, rely = 0.3)

Yourmail = tkinter.Label(pageThree, text = " ", bg = "light green", font = "Papyrus, 40")
Yourmail.place(relx = 0.25, rely = 0.35)
...
Ontohomepage = tkinter.Button(pageThree, text = "Finished!", font = "Papyrus, 50", command = Homepaging)
